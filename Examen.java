...
El alumno creará una aplicación en javafx con un formulario con los siguientes campos, con un Text o label a la izquierda de cada campo:

nombre textfield
edad desplegable de 1 a 20
raza desplegable (pastor alemán, bulldog, chihuahua, pitbull)
Pedigrí checkbox
Precio slider 1-2000

PARTE II(4 PUNTOS)

En la parte inferior habrá un botón, al pulsar el botón aparecerá una ventana mostrando los datos del
 formulario de forma ordenada y con la presentación adecuada.
